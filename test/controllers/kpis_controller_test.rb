...
class KpisControllerTest < ActionController::TestCase
  ...
  test "should create kpi" do
    assert_difference('Kpi.count') do
      post :create, kpi: { baseline: @kpi.baseline, description: @kpi.description, target: @kpi.target, title: @kpi.title, weighting: @kpi.weighting }
    end
  ...
  test "should update kpi" do
    patch :update, id: @kpi, kpi: { baseline: @kpi.baseline, description: @kpi.description, target: @kpi.target, title: @kpi.title, weighting: @kpi.weighting }
    assert_redirected_to kpi_path(assigns(:kpi))
  end
